...
Page({
  ...
  data: {
    ...
    "shopList": [
      ...
      //   ],
      //   "roleId": "",    //角色ID
      //   "businessName": "123123123",    //角色  如文化礼仪
      //   "shopName": "sadadas",      //商家名称
      //   "shopAddress": "31231gg"     //商家地址
      // },
  ...
  switToSDetail: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/w_store_detail_vip/w_store_detail_vip?flag='+0+ '&roleId=' + this.data.shopList[id].roleId
    })
  },
  ...
  getShopList: function (pageStart) {
    ...
    wxRequest('/homePage/getMerchants',{ area: that.data.area, flag: 0, type: that.data.type }, function (res) {
      console.log(res)
      if (res.data.status == 'success') {
        that.setData({
          pageTotal: res.data.result.pageTotal,
