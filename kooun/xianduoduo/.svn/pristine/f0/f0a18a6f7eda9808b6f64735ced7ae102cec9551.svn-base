...
function ajaxHttp() {
    ...
    // return 'http://192.168.1.38:8099/kooun-car-admin'
    return 'http://192.168.1.32:8100/kooun-xianduoduo-admin'
}

var uploadHttp = uploadFile()
function uploadFile() {
    return 'http://192.168.1.32:8380/magicfile'
    // return 'http://file.pczht.com/kooun-file'
    // return 'http://xycy3.infotoo.com.cn/kooun-file'
}
